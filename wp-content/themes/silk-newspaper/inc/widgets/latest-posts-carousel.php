...
if (!class_exists('silknewspaper_post_carousel')) {

  class silknewspaper_post_carousel extends WP_Widget
  {
    public function __construct()
    {
      $widget_ops = array(
        'classname' => 'silknewspaper_post_carousel',
        'description' => __('(blog carousel style) Displays latest posts or posts from a choosen category.', 'silk-newspaper'),
        'customize_selective_refresh' => true,
      );
      parent::__construct('silknewspaper-latestpost-carousel', __('&hearts; silknewspaper-Post Carousel', 'silk-newspaper'), $widget_ops);
      $this->alt_option_name = 'silknewspaper_latestpost_carousel';
    }
...
?>
    ...
    ?>
      ...
      <p>
        <label for="<?php echo $this->get_field_id('slidesto_show'); ?>"><?php esc_html_e('slides to show', 'silk-newspaper'); ?></label>
      ...
      <p>
        <label for="<?php echo $this->get_field_id('auto_play'); ?>"><?php esc_html_e('Auto play', 'silk-newspaper') ?></label>
        <select id="<?php echo $this->get_field_id('auto_play'); ?>" name="<?php echo $this->get_field_name('auto_play'); ?>" class="widefat">
          <option value="true" <?php if ('true' == $instance['auto_play']) echo 'selected="selected"'; ?>><?php esc_html_e('ON', 'silk-newspaper') ?></option>
          <option value="false" <?php if ('false' == $instance['auto_play']) echo 'selected="selected"'; ?>><?php esc_html_e('OFF', 'silk-newspaper') ?></option>
        </select>
      </p>
...
function silknewspaper_latest_post_carousel()
{
  register_widget('silknewspaper_post_carousel');
}
add_action('widgets_init', 'silknewspaper_latest_post_carousel');
