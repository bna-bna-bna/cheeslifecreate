...
if ( ! class_exists( 'Weight_Loss_Trainer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Weight_Loss_Trainer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Weight_Loss_Trainer_WPTT_WebFont_Loader( $url );
