...
class Weight_Loss_Trainer_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function weight_loss_trainer_loadClassLoader($class)
    {
    ...
    public static function weight_loss_trainer_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
