...
class Weight_Loss_Trainer_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function weight_loss_trainer_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function weight_loss_trainer_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function weight_loss_trainer_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function weight_loss_trainer_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->weight_loss_trainer_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function weight_loss_trainer_load( $class ) {
